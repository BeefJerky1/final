					...
					<div class="col-lg-12 col-md-12 col-sm-12 text-end">
						<div class="col-lg-5 col-md-5 col-sm-5 offset-9 mt-5">
							<button type="button" class=" btn btn-success"
								v-on:click="this.cancel=false" v-if=cancel>등록</button>
						</div>
						<div v-if="cancel"></div>
						<div v-else>
							<div class="col-lg-5 col-md-5 col-sm-5 offset-9 mt-5">
								<div>
									<form class="form-floating">
										<input class="form-control" type="number" v-model="animalNo"
											id="animalNo"> <label for="animalNo">동물 번호</label>
									</form>
								</div>
								<div>
									<form class="form-floating">
										<input class="form-control" type="text" v-model="animal"
											id="animal"> <label for="animal">동물</label>
									</form>
								</div>
								<div>
									<form class="form-floating">
										<input class="form-control" type="text" v-model="mbti"
											id="mbti"> <label for="mbit">mbti</label>
									</form>
								</div>
								<div>
									<input class="form-control" type="file" accept="image/*"
										ref="photo" name="photo" />
								</div>
								<button type="button" class=" btn btn-success"
									v-on:click="addAnimal()">등록</button>
								<button type="button" class=" btn btn-secondary"
									v-on:click="this.cancel=true">취소</button>
							</div>
						</div>
					</div>
					<div class="col-lg-12 col-md-12 col-sm-12 mb-5"
						...
						<div v-for="(animal, index) in mbtianimal">
							<div class="card" style="width: 18rem;">
								...
								<div v-else>
									<img class="card-img-top"
										src="https://via.placeholder.com/250/69f/fff.png"
										alt="Card image cap">
								</div>
								<div class="card-body">
									...
									<button type="button" class=" btn btn-danger"
										v-on:click="deleteAnimal(index)">삭제</button>
								</div>
							</div>
						</div>
					</div>
