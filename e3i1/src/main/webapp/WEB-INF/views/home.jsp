    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicators"
            ...
            <div class="main-area text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 600px;">
                ...
                <h1 class="mb-4 main-title fw-black">What is my MBTI type? <i class="fa-solid fa-face-smile" style="color:#f7d68a"></i></h1>
            </div>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="p-lg-5 ps-lg-0 main-content">
                        ...
                        <p class="mb-4 pb-2" style="font-weight : 600;">
                        ...
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <p class="mb-0 fw-medium">Find My MBTI</p>
                            ...
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <p class="mb-0 fw-medium">My Animal Type</p>
                                        <h6 class="mb-0">#사랑둥이 강아지</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <p class="mb-0 fw-medium">My Favortie</p>
                                        <h6 class="mb-0">#액티비티매니아</h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <p class="mb-0 fw-medium">Persnal Club</p>
                                        <h6 class="mb-0">free community</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
          ...
          data() {
            ...
            computed:{
              ...
              methods:{
            	...
            	// mbti 게시판 디테일 페이지
            		toMbtiDetailPage(index){
            			window.location.href="${pageContext.request.contextPath}/mbtiBoard/detail?mbtiBoardNo="+this.mbtiBoardList[index].mbtiBoardDto.mbtiBoardNo;
            		},
            },
            ...
            created() {
            	// 소모임 목록 불러오기
            	axios({
            			url: "${pageContext.request.contextPath}/rest/home/bestClub",
            			method: "get",
            		}).then((resp) => {
            	 ...
            	 axios({
            			url: "${pageContext.request.contextPath}/rest/home/bestMbtiBoard",
            			method: "get",
            		}).then((resp) => {
            			this.mbtiBoardList.push(...resp.data);
            		})
            	},
        });
