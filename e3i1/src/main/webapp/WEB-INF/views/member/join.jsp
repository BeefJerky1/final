...
<jsp:include page="/WEB-INF/views/template/header.jsp"></jsp:include>    
    ...
    <div class="container w500">
      ...
      <div class="container w500 m30 page">
        ...
        <div class="row">
        <label>관심분야1</label>
           <select name="memberInterest1" class="form-input input-round">
	    		<option value="">선택</option>
	    ...
	    <div class="row">
	    <label>관심분야2</label>
           <select name="memberInterest2" class="form-input input-round">
	    		<option value="">선택</option>
	    		<option>#액티비티매니아</option>
	    		<option>#인스타그래머</option>
	    		<option>#금손모임</option>
	    ...
	    <div class="row">
	    <label>관심분야3</label>
           <select name="memberInterest3" class="form-input input-round">
	    		<option value="">선택</option>
	    		<option>#액티비티매니아</option>
	    		<option>#인스타그래머</option>
	    		<option>#금손모임</option>
        ...
        <div class="row">
	    <label>지역</label>
           <select name="memberPlace1" class="form-input input-round">
	    		<option value="">선택</option>
	    		<option>강남구</option>
	    		<option>동구</option>
